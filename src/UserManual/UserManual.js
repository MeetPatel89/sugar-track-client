            ...
            <>
                ...
                <section className='user-manual'>
                    ...
                    <ul className="user-manual-list">
                        <li>Log blood glucose as follows:
                            <ul>
                        ...
                        <li>Log medications as follows:
                            <ul>
                                <li>If you have one medication (e.g. insulin) at a given time then log that medication ('insulin') along with date and time.</li>
                                <li>If you have more than one medication at one go (e.g. insulin, metformin and atenolol) then log all those medications ('insulin, metformin, atenolol') along with date and time.</li>
                                <li>You are not allowed to log more than one medication regimen for the same date-time.</li>
                            </ul>
                        </li>
                        <li>Log meals as follows:
                            <ul>
                                <li>Log meals everytime you eat or drink something that has caloric value.</li>
                                <li>Keep it brief, you are not writing a recipe. For e.g. 'egg-sandwich', 'cheese fries', 'Indian meal', etc.</li>
