    ...
    <>
      <main className="main-container">
        <section className="user-manual">
          <h2>User Manual</h2>
          <p>
            Sugar-Track allows you to log metrics for glucose levels,
            medications and meals so that you can visualize them on a graphical
            interface. You can log any number of values but we have some
            recommendations so that you can optimize this app.
          </p>
          <ul className="user-manual-list">
            <li>
              ...
              <ul>
                ...
                <li>
                  After meal: Log glucose value about one hour after every meal
                  of the day. For instance log glucose after having breakfast,
                  after having dinner, etc.
                </li>
            ...
            <li>
              ...
              <ul>
                ...
                <li>
                  You are not allowed to log more than one medication regimen
            ...
            <li>
              ...
              <ul>
                <li>
                  Log meals everytime you eat or drink something that has
                  caloric value.
                </li>
                <li>
                ...
                <li>
                  You are not allowed to log more than one meal value for the
                  same date-time.
                </li>
              </ul>
            </li>
            ...
            <li>
              You can edit and delete any of the logs but we recommend you use
              it cautiously to avoid introducing any inaccuracy in your logs.
            </li>
          </ul>
        </section>
      </main>
