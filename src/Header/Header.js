...
export default class Header extends Component {
    ...
    render() {
        let welcomeMsg;
    if (this.props.user) {
        welcomeMsg = <p className="flex-container"><span className="welcome-msg">Welcome {this.props.user}</span><span><button type="button" className="log-out" onClick={this.props.handleLogOut}>Log out</button></span></p>
    } else {
